...
var Gradient = (props) => {
  ...
  return import_react.default.createElement(import_ink.Transform, { transform: applyGradient }, props.children);
};
Gradient.propTypes = {
...
\u255A\u2550\u255D  \u255A\u2550\u255D\u255A\u2550\u255D  \u255A\u2550\u255D\u255A\u2550\u255D  \u255A\u2550\u255D  \u255A\u2550\u2550\u2550\u255D  \u255A\u2550\u2550\u2550\u2550\u2550\u2550\u255D   \u255A\u2550\u255D
`.trim();
var Header = () => /* @__PURE__ */ import_react2.default.createElement(import_ink2.Box, { flexDirection: "column", alignItems: "center", paddingBottom: 1 }, /* @__PURE__ */ import_react2.default.createElement(dist_default, { name: "morning" }, /* @__PURE__ */ import_react2.default.createElement(import_ink2.Text, { bold: true }, HEADER_ASCII)), /* @__PURE__ */ import_react2.default.createElement(import_ink2.Box, { marginTop: 1, width: 80 }, /* @__PURE__ */ import_react2.default.createElement(import_ink2.Text, { color: "gray", dimColor: true, italic: true, wrap: "wrap", textAlign: "center" }, "An intelligent research agent that tracks your goals, recalls contextually relevant information, and reasons across long, interleaved tasks to provide precise insights")));
var ChatHistory = ({ history }) => /* @__PURE__ */ import_react2.default.createElement(import_ink2.Box, { flexDirection: "column", paddingBottom: 1 }, history.map((message, index) => /* @__PURE__ */ import_react2.default.createElement(import_ink2.Text, { key: index }, message)));
var InputBox = ({ value }) => {
  const parts = value.split(/(@\S+)/);
  return /* @__PURE__ */ import_react2.default.createElement(import_ink2.Box, { borderStyle: "single", paddingX: 1 }, /* @__PURE__ */ import_react2.default.createElement(import_ink2.Text, null, parts.map((part, i) => {
    if (part.startsWith("@")) {
      return /* @__PURE__ */ import_react2.default.createElement(import_ink2.Text, { key: i, color: "red" }, part);
    }
    return part;
  }), "\u2588"));
};
var FileSuggestions = ({ suggestions, activeIndex }) => {
  ...
  return /* @__PURE__ */ import_react2.default.createElement(import_ink2.Box, { flexDirection: "column", borderStyle: "single", width: 80 }, suggestions.map((suggestion, index) => {
    const color = index === activeIndex ? "red" : "white";
    return /* @__PURE__ */ import_react2.default.createElement(import_ink2.Text, { key: suggestion, color }, suggestion);
  }));
};
var App = () => {
  ...
  const [suggestionBoxVisible, setSuggestionBoxVisible] = (0, import_react2.useState)(false);
  const [activeIndex, setActiveIndex] = (0, import_react2.useState)(0);
  (0, import_react2.useEffect)(() => {
    if (suggestionBoxVisible) {
      import_fs.default.readdir(process.cwd(), (err, files) => {
        if (err) {
        } else {
  ...
  return /* @__PURE__ */ import_react2.default.createElement(import_ink2.Box, { flexDirection: "column", width: "100%", height: "100%" }, /* @__PURE__ */ import_react2.default.createElement(Header, null), /* @__PURE__ */ import_react2.default.createElement(ChatHistory, { history }), /* @__PURE__ */ import_react2.default.createElement(import_ink2.Box, { flexGrow: 1 }), /* @__PURE__ */ import_react2.default.createElement(
    InputBox,
    {
      value: inputValue
    }
  ), suggestionBoxVisible && /* @__PURE__ */ import_react2.default.createElement(FileSuggestions, { suggestions, activeIndex }));
};
(0, import_ink2.render)(/* @__PURE__ */ import_react2.default.createElement(App, null));
